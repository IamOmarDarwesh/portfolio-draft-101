...
<style>
  .glass-card {
    ...
    border: 1px solid rgba(255, 255, 255, 0.2); /* subtle outer frame */
    border-radius: 20px;
    padding: 28px 24px;
    max-width: 800px;
    margin: 30px auto;
    font-family: 'San Francisco', 'Inter', 'Segoe UI', Arial, sans-serif;
    color: #eaeaea;
    line-height: 1.7;
    font-size: 1rem;
  ...
  /* Hover effect for subtle Apple-style interaction */
  .glass-card:hover {
